...
<body onload="onLoadData()">
	...
	<s:form name="saveTableReservation" method="POST" action="saveTableReservation.html" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
		...
		<div id="tab_container" style="overflow: hidden;">
				<ul class="tabs" style=" margin-left: 100px;">
						<li class="active" data-state="tab1" style="width: 20%; padding-left: 4%; height: 25px; border-radius: 4px;">Table Reservation</li>
...
<!-- 	Start of Tab1 -->
		    ...
		    <div id="tab1" class="tab_content">
				...
				<div class="title">
					...
					<div class="row" style="background-color: #fff; display: -webkit-box;margin-bottom: 10px;margin-left: 85px;">
...
<!-- 	Start of Tab2 		 -->
		  ...
		  <div id="tab2" class="tab_content">
				...
				<div class="title">
						...
						<div class="row" style="background-color: #fff; display: -webkit-box;margin-left: 85px;margin-bottom: 10px;">
							<div class="element-input col-lg-6" style="width: 15%;"> 
					...
					<div class="row" style="background-color: #fff; display: -webkit-box; margin-bottom: 10px;margin-left: 140px;">
		    		...
		    		<div style="background-color: #fff;margin-bottom: 10px;margin-left: 20px;">
		    			
		    			<table style="width: 85%; margin: auto; border: 1px solid #ccc;" >
						...
						<div style=" border: 1px solid #ccc;height: 150px; margin: auto; overflow-y: scroll; width: 85%;">
