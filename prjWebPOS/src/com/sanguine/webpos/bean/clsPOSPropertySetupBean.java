...
public class clsPOSPropertySetupBean {
	...
	public void setChkPrintInclusiveOfAllTaxesOnBill(
			String chkPrintInclusiveOfAllTaxesOnBill) {
	...
	public void setChkBoxAllowNewAreaMasterFromCustMaster(
			String chkBoxAllowNewAreaMasterFromCustMaster) {
	...
	public void setChkAllowToCalculateItemWeight(
			String chkAllowToCalculateItemWeight) {
	...
	public void setChkExpDateForCreditCardBillYN(
			String chkExpDateForCreditCardBillYN) {
	...
	public void setChkDelBoyCompulsoryOnDirectBiller(
			String chkDelBoyCompulsoryOnDirectBiller) {
	...
	public void setChkEnableSettleBtnForDirectBillerBill(
			String chkEnableSettleBtnForDirectBillerBill) {
	...
	public void setChkMultipleWaiterSelectionOnMakeKOT(
			String chkMultipleWaiterSelectionOnMakeKOT) {
	...
	public void setChkDontShowAdvOrderInOtherPOS(
			String chkDontShowAdvOrderInOtherPOS) {
	...
	public void setChkPrintZeroAmtModifierInBill(
			String chkPrintZeroAmtModifierInBill) {
	...
	public void setChkPopUpToApplyPromotionsOnBill(
			String chkPopUpToApplyPromotionsOnBill) {
	...
	public void setChkPrintRemarkAndReasonForReprint(
			String chkPrintRemarkAndReasonForReprint) {
	...
	public void setChkEnableBothPrintAndSettleBtnForDB(
			String chkEnableBothPrintAndSettleBtnForDB) {
	...
	public void setChkCarryForwardFloatAmtToNextDay(
			String chkCarryForwardFloatAmtToNextDay) {
	...
	public void setChkOpenCashDrawerAfterBillPrint(
			String chkOpenCashDrawerAfterBillPrint) {
	...
	public void setChkShowItemDtlsForChangeCustomerOnBill(
			String chkShowItemDtlsForChangeCustomerOnBill) {
	...
	public void setChkShowPopUpForNextItemQuantity(
			String chkShowPopUpForNextItemQuantity) {
	...
	public void setChkMemberCodeForKotInMposByCardSwipe(
			String chkMemberCodeForKotInMposByCardSwipe) {
	...
	public void setChkMemberCodeForMakeBillInMPOS(
			String chkMemberCodeForMakeBillInMPOS) {
	...
	public void setChkSelectCustomerCodeFromCardSwipe(
			String chkSelectCustomerCodeFromCardSwipe) {
	...
	public void setChkAutoAreaSelectionInMakeKOT(
			String chkAutoAreaSelectionInMakeKOT) {
