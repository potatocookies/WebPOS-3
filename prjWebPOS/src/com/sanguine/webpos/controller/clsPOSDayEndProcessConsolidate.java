...
//frmPOSShiftEndProcessConsolidate
	...
	public ModelAndView funOpenForm(Map<String,Object> model, HttpServletRequest request,ModelMap modelmap)
	{
		...
		String posURL ="http://localhost:8080/prjSanguineWebService/DayEndProcessTransaction/funGetAllParameterValuesPOSWise"
				+ "?POSCode="+strPOSCode+"&clientCode="+strClientCode;
	...
	public @ResponseBody ModelAndView funConsolidateStartDayProcess(HttpServletRequest req)
	{
		...
		return new ModelAndView("frmPOSShiftEndProcessConsolidate");//return jsonDayStart; //new clsDayEndProcessBean();
	}
	...
	public @ResponseBody ModelAndView funConsolidateEndDayProcess(@RequestParam("emailReport") String EmailReport, HttpServletRequest req)
	{
		...
		//JSONObject jObj = objGlobalFunctions.funGETMethodUrlJosnObjectData("http://localhost:8080/prjSanguineWebService/DayEndProcessTransaction/funDayEndProcess?strPOSCode="+strPOSCode+"&shiftNo="+ShiftNo+"&strUserCode="+userCode+"&strClientCode="+strClientCode);
