...
//				map.put(josnObjRet.get("strItemCode"), josnObjRet.get("strItemName"));
//			}	
//			model.put("itemList",itemList);
	...
	public @ResponseBody JSONObject funloadBillAndDelBoyData(HttpServletRequest req)
	{
		...
		String posUrl = clsPOSGlobalFunctionsController.POSWSURL+"/APOSMastersIntegration/funFillItemTable"
	...
	public @ResponseBody JSONObject funGetNonAvailableItems(HttpServletRequest req)
	{
		...
		String posUrl = clsPOSGlobalFunctionsController.POSWSURL+"/APOSIntegration/funGetNonAvailableItems"
