...
public class clsPOSSettlementMasterBean {
	...
	private double dblConversionRatio;
	...
	public double getDblConversionRatio() {
		return dblConversionRatio;
	}

	public void setDblConversionRatio(double dblConversionRatio) {
		this.dblConversionRatio = dblConversionRatio;
	}
