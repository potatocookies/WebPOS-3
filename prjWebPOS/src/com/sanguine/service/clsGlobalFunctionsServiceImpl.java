...
public class clsGlobalFunctionsServiceImpl implements clsGlobalFunctionsService
{
	...
	@Override
	public long funGetPMSMasterLastNo(String tableName, String masterName,
			String columnName, String clientCode) {
	...
	{
		return objGlobalDao.funDeleteWebBookTempLedger(clientCode,userCode,propertyCode);
	}*/
	...
	{
		return objGlobalDao.funAddCurrentDebtorCredtor(clientCode,userCode,propertyCode);
	}
