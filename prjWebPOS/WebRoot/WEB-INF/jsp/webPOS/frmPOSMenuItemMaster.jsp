...
<body>
	...
	<s:form name="menuItemMaster" method="POST" action="saveMenuItemMaster.html?saddr=${urlHits}" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
	...
	<div class="title" style="margin-left: 50px;">
			...
			<div class="row" style="background-color: #fff; display: -webkit-box;margin-bottom: 10px;">
    			...
    			<div class="element-input col-lg-6" style="width: 20%;">
					<s:input class="large" colspan="3" type="text" id="txtItemCode" path="strItemCode"  ondblclick="funHelp('POSMenuItemMaster');" style="width: 100%" />
				</div>
				<div class="element-input col-lg-6" style="width: 20%;">
					<label class="title" style="width: 100%">External Code</label>
				</div>
    			<div class="element-input col-lg-6" style="width: 20%;">
					<s:input class="large" colspan="3" type="text" id="txtExternalCode" path="strExternalCode"  style="width: 100%"/>
				</div> 
			</div>
			...
			<div class="row" style="background-color: #fff; display: -webkit-box;margin-bottom: 10px;">
    			...
    			<div class="element-input col-lg-6" style="width: 60%;">
					<s:input class="large" colspan="3" type="text" id="txtItemName" path="strItemName" style="width: 100%" />
				</div>
			</div>
			...
			<div class="row" style="background-color: #fff; display: -webkit-box;margin-bottom: 10px;">
    			...
    			<div class="element-input col-lg-6" style="width: 20%;">
					<s:input class="large" colspan="3" type="text" id="txtShortName" path="strShortName" style="width: 100%" />
				</div>
			...
			<div class="row" style="background-color: #fff; display: -webkit-box;">
    				...
    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 20%;"> 
						<s:select id="txtSubGroupCode" path="strSubGroupCode" items="${subGroup}" ></s:select>
					</div>
			 	</div>
			 	...
			 	<div class="row" style="background-color: #fff; display: -webkit-box;">
    				...
    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 20%;">
    					 <s:input id="txtSalePrice" path="dblSalePrice" type="number" min="0" step="1" style="text-align: right;width: 100%;" />
			 		</div>
			 	</div>
			 	...
			 	<div class="row" style="background-color: #fff; display: -webkit-box;">
					...
					<div class="element-input col-lg-6" style="width: 20%;"> 
			 		...
			 		<div class="element-input col-lg-6" style="width: 20%;">
			 		<s:select id="txtTargetMissTimeMin" path="tmeTargetMiss" items="${ProcessTime}" >
	    			</s:select>
					<label> Minutes</label>
					</div>
			 	...
			 	<div class="row" style="background-color: #fff; display: -webkit-box;margin-bottom: 10px">
					<div class="element-input col-lg-6" style="width: 20%;"> 
			 		...
			 		<div class="element-input col-lg-6" style="width: 20%;">
	    				<s:input  id="txtMinLevel" path="dblMinLevel" type="number" min="0" step="1" style="text-align: right;width: 100%;" />
					</div>
					<div class="element-input col-lg-6" style="width: 20%;"> 
			 		<label class="title" style="width: 100%">Processing Time</label>
			 		</div>
			 		<div class="element-input col-lg-6" style="width: 20%;">
	    			<s:select id="txtProcTimeMin" path="intProcTimeMin" items="${ProcessTime}" >
	    			</s:select>	
					<label> Minutes</label>
			 	...
			 	<div class="row" style="background-color: #fff; display: -webkit-box;margin-bottom: 10px">
	    			...
	    			<div class="element-input col-lg-6" style="width: 20%;">
	    				<s:input  id="txtMaxLevel" path="dblMaxLevel" type="number" min="0" step="1" style="text-align: right;width: 100%;" />
					</div>
					<div class="element-input col-lg-6" style="width: 20%;">
			 	...
			 	<div class="row" style="background-color: #fff; display: -webkit-box;margin-bottom: 10px">
					...
					<div class="element-input col-lg-6" style="width: 5%;">
	    				<s:input type="checkbox"  id="chkItemWiseKOTYN" path="strItemWiseKOTYN"></s:input>
					</div>
					<div class="element-input col-lg-6" style="width: 14%;">
						<label class="title" style="width: 100%">No Discount</label>
					</div>
					<div class="element-input col-lg-6" style="width: 5%;">
	    				<s:input type="checkbox"  id="chkDiscountApply" path="strDiscountApply"></s:input>
					</div> 
			   </div>
			   ...
			   <div class="row" style="background-color: #fff; display: -webkit-box;margin-bottom: 10px">
    				...
    				<div class="element-input col-lg-6" style="width: 20%;"> 
						<s:textarea id="txtItemDetails" path="strItemDetails" name="textarea" style="min-width: 150px; min-height: 50px;"/>
					</div>
				</div>
	</div>
