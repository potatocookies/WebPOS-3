	...
	function funFillPrinterDtl(strCode,strName,primaryPrinter,secondaryPrinter,strPrintOnBothPrintersYN)
	{
		...
		var row = table.insertRow(rowCount);
		 ...
		 row.insertCell(0).innerHTML= "<input type=\"hidden\" name=\"listPrinterDtl["+(rowCount)+"].strCostCenterCode\" readonly=\"readonly\" class=\"Box \" size=\"0%\" id=\"strCodes."+(rowCount)+"\" value='"+strCode+"'>";
	      ...
	      row.insertCell(1).innerHTML= "<input name=\"listPrinterDtl["+(rowCount)+"].strCostCenterName\" readonly=\"readonly\" class=\"Box \" size=\"40%\" id=\"strCostCenterName."+(rowCount)+"\" value='"+strName+"'>";
		  row.insertCell(2).innerHTML= "<input name=\"listPrinterDtl["+(rowCount)+"].strPrimaryPrinterPort\" readonly=\"readonly\" class=\"Box \" size=\"20%\" id=\"strPrimaryPrinterPort."+(rowCount)+"\" value='"+primaryPrinter+"'>";
		  row.insertCell(3).innerHTML= "<input name=\"listPrinterDtl["+(rowCount)+"].strSecondaryPrinterPort\" readonly=\"readonly\" class=\"Box \" size=\"20%\" id=\"strSecondaryPrinterPort."+(rowCount)+"\" value='"+secondaryPrinter+"'>";
