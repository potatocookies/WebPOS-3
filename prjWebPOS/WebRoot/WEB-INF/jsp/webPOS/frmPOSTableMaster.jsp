...
<body onload="funLoadTableData()">
	...
	<s:form name="POSTableMaster" method="POST" action="savePOSTableMaster.html?saddr=${urlHits}" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
	
		<div id="tab_container" style="padding-left: 25%; overflow: hidden; height: auto;" >
				<ul class="tabs">
							<li class="active" data-state="tab1" style="width: 25%; padding-left: 5%; height: 25px; border-radius: 4px;">Table Master</li>
							<li data-state="tab2" style="width: 25%; padding-left: 5%; height: 25px; border-radius: 4px;">Table Sequence</li>
				</ul>
			...
			<div id="tab1" class="tab_content">
				...
				<div class="row" style="background-color: #fff;display: -webkit-box;">
	    				...
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 25%;"> 
							<s:input class="large" colspan="3" type="text" id="txtTableNo" path="strTableNo"  ondblclick="funHelp('POSTableMaster')"/>
						</div>
						<div class="element-input col-lg-6" style="width: 20%;" > 
	    					<label class="title">Table Name</label>
	    				</div>
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 25%;"> 
							<s:input class="large" colspan="3" type="text" id="txtTableName" path="strTableName" />
						</div>
			 	</div>
			 	...
			 	<div class="row" style="background-color: #fff;display: -webkit-box;">
	    				...
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 25%;"> 
							<s:input class="large" colspan="3" type="text" id="txtPaxNo" path="intPaxCapacity" />
						</div>
						<div class="element-input col-lg-6" style="width: 20%;" > 
				 ...
				 <div class="row" style="background-color: #fff;display: -webkit-box;">
				  ...
				  <div class="row" style="background-color: #fff;display: -webkit-box;">
	    				...
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 25%;"> 
	    					<s:select id="txtWaiterName" path="strWaiterName" items="${waiterList}" />
	    				</div>
				 </div>
				 ...
				 <br/>
				  ...
				  <div class="col-lg-10 col-sm-10 col-xs-10" style="width: 70%;">
						 <p align="center">
								<div class="submit col-lg-4 col-sm-4 col-xs-4"><input type="submit" id="tblMaster" value="Submit" /></div>
	...
	<!--  Start of tab2-->
		...
		<div id="tab2" class="tab_content">
			...
			<div style="border: 1px solid #ccc; display: block; height: 200px; overflow-x: hidden; overflow-y: scroll; width: 100%;">
					<table style="background-color:  #2fabe9a1;width: 100%;border: 1px solid;" >
		    				<thead>
									<tr>
				 ...
				 <table id="tblTable" style="background-color:  #d9edf742;width: 100%;border: 1px solid;">
			...
			<br />
			 ...
			 <div class="col-lg-10 col-sm-10 col-xs-10" style="width: 70%; margin-left: 30%;">
				 <p align="center">
					 <div class="submit col-lg-4 col-sm-4 col-xs-4"><input type="submit" id="tblSequence" value="Submit" /></div>
				 </p>
		     </div>
