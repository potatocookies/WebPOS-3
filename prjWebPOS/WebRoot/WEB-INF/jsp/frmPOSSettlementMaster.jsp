			...
			<div id="tab1" class="tab_content">
				...
				<div class="row" style="background-color: #fff;">
	    				...
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;"> 
							<s:input class="large" colspan="3" type="text" id="txtSettelmentCode" path="strSettelmentCode" ondblclick="funHelp('POSSettlementMaster')"/>
						</div>
			 	</div>
		 		...
		 		<div class="row" style="background-color: #fff; display: inline-flex; margin-bottom: 10px;">
		    			...
		    			<div class="element-input col-lg-6" style="width: 26%; margin-left: 6%;">
		    				<s:input class="large" colspan="3" type="text" id="txtThirdPartyComission" path="dblThirdPartyComission" style="width: 50px;"/>
