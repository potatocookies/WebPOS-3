	 ...
	 @SuppressWarnings("rawtypes")
		...
		public void funReport(@ModelAttribute("command") clsPOSReportBean objBean, HttpServletResponse resp,HttpServletRequest req,String source)
		{
			...
			if(reportType.equalsIgnoreCase("Item Wise"))
            {
            	...
            	listOfWaiterWiseItemSales = objReportService.funProcessWaiterWiseItemWiseIncentivesSummaryReport(posCode,fromDate,toDate,strShiftNo,enableShiftYN,groupCode,subGroupCode,reportType);
