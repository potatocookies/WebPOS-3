...
<body >
	...
	<s:form name="VoidKOTReport" method="POST" action="rptVoidKOTReport.html?saddr=${urlHits}" target="_blank" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
...
<!-- 			</tr> -->
<!-- 			<tr> -->
<!-- 			<td width="140px">Report Sub Type</td> -->
<%-- 				<td ><s:select id="cmbReportSubType" name="cmbReportSubType" path="strReportType" cssClass="BoxW124px" items="${listReportSubType}" > --%>
<%-- 				</s:select></td> --%>
<!-- 				 <td></td> -->
<!-- 				 <td></td> -->
<!-- 			</tr> -->
