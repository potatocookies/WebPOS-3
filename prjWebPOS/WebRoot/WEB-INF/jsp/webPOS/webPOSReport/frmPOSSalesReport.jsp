								...
								.each(
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												var row = table
														.insertRow(rowCount);
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"65%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
											...
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field2."
													...
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"43%\" id=\"field3."
													+ (rowCount)
													+ "\" style=\"text-align:right;\" value='"
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"43%\" id=\"field4."
													+ (rowCount)
													+ "\" style=\"text-align:right;\" value='"
								...
								.each(
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												var row = table
														.insertRow(rowCount);
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"20%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\"  />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"36%\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"26%\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalDiscAmt
														+ "'/>";
												row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"26%\" id=\"Totfield4."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalTaxAmt
														+ "'/>";
												row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"25%\" id=\"Totfield5."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSettleAmt
														+ "'/>";
												row.insertCell(5).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"16%\" id=\"Totfield6."
														+ (rowCount)
														+ "\" value='"
											...
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"10%\" style=\"text-align:center;\" id=\"field2."
													...
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"4%\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"4%\" style=\"text-align:right;\" id=\"field4."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField4
													+ "'/>";
											row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"6%\" id=\"field5."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField5
													+ "'/>";
											row.insertCell(5).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"6%\" id=\"field6."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField6
													+ "'/>";
											row.insertCell(6).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"6%\" id=\"field7."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField7
													+ "'/>";
											row.insertCell(7).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"6%\" style=\"text-align:right;\" id=\"field8."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField8
													+ "'/>";
											row.insertCell(8).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"10%\" style=\"text-align:right;\" id=\"field9."
													+ (rowCount)
													+ "\" value='"
											...
											row.insertCell(9).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"8%\" style=\"text-align:right;\" id=\"field10."
													...
													+ "'/>";
											row.insertCell(10).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"7%\" style=\"text-align:right;\" id=\"field11."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField11
													+ "'/>";
											row.insertCell(11).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"13%\" style=\"text-align:right;\" id=\"field12."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField12
													+ "'/>";
											row.insertCell(12).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"13%\" style=\"text-align:right;\" id=\"field13."
													+ (rowCount)
													+ "\"  value='"
													+ response[i].strField13
													+ "'/>";
											row.insertCell(13).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"5%\" id=\"field14."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField14
													+ "'/>";
											row.insertCell(14).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"5%\" style=\"text-align:right;\" id=\"field15."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField15
													+ "'/>";
											row.insertCell(15).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"5%\" id=\"field16."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField16
													+ "'/>";
											row.insertCell(16).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"5%\" id=\"field17."
													+ (rowCount)
													+ "\" value='"
								...
								.each(
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												var row = table
														.insertRow(rowCount);
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"87%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"25%\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalQuantity
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"22%\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalAmount
														+ "'/>";
												row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"22%\" id=\"Totfield4."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
											...
											var row = table.insertRow(rowCount);
											i = i + 1;
											row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"51%\" id=\"field1."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField1
													+ "'/>";
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"32%\" id=\"field2."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"23%\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"23%\" id=\"field4."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField4
													+ "'/>";
											row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"24%\" id=\"field5."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField5
													+ "'/>";
								...
								.each(
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												var row = table
														.insertRow(rowCount);
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"50%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"28%\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalQuantity
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"28%\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalAmount
														+ "'/>";
												row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"40%\" id=\"Totfield4."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
												row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"27%\" id=\"Totfield5."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalDiscAmt
														+ "'/>";
											...
											var row = table.insertRow(rowCount);
											i = i + 1;
											row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"23%\" id=\"field1."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField1
													+ "'/>";
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"24%\" id=\"field2."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"24%\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"24%\" id=\"field4."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField4
													+ "'/>";
											row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"24%\" id=\"field5."
													...
													+ response[i].strField5
													+ "'/>";
											row.insertCell(5).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"24%\" id=\"field6."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField6
													+ "'/>";
											row.insertCell(6).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"23%\" id=\"field7."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField7
													+ "'/>";
								...
								.each(
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												var row = table
														.insertRow(rowCount);
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"46%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"27%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalQuantity
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"36%\" style=\"text-align:right;\" id=\"Totfield3."
														...
														+ response[i].totalAmount
														+ "'/>";
												row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"36%\" style=\"text-align:right;\" id=\"Totfield4."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
												row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"27%\" style=\"text-align:right;\" id=\"Totfield5."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalDiscAmt
														+ "'/>";
											...
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"24%\" id=\"field2."
													...
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"23%\" style=\"text-align:right;\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"23%\" style=\"text-align:right;\" id=\"field4."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField4
													+ "'/>";
											row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"23%\" style=\"text-align:right;\" id=\"field5."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField5
													+ "'/>";
											row.insertCell(5).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"23%\" style=\"text-align:right;\" id=\"field6."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField6
													+ "'/>";
											row.insertCell(6).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"23%\" style=\"text-align:right;\" id=\"field7."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField7
													+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"28%\" id=\"Totfield2."
														...
														+ response[i].totalQuantity
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"30%\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalAmount
														+ "'/>";
												row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"36%\" id=\"Totfield4."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
												row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"28%\" id=\"Totfield5."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalDiscAmt
														+ "'/>";
											...
											row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"23%\" id=\"field5."
													...
													+ response[i].strField5
													+ "'/>";
											row.insertCell(5).innerHTML = "<input readonly=\"readonly\" class=\"Box\" style=\"text-align:right;\" size=\"18%\" id=\"field6."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField6
													+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"48%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalQuantity
														+ "'/>";
											...
											row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field1."
													...
													+ response[i].strField1
													+ "'/>";
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"58%\" style=\"text-align:right;\" id=\"field2."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"58%\" style=\"text-align:right;\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
								...
								.each(
										...
										function(i, item) {
											...
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field2."
													...
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"69%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalQuantity
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"38%\" style=\"text-align:right;\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
												row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"29%\" style=\"text-align:right;\" id=\"Totfield4."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalAmount
														+ "'/>";
											...
											var row = table.insertRow(rowCount);
											i = i + 1;
											row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"25%\" id=\"field1."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField1
													+ "'/>";
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"25%\" id=\"field2."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"24%\" style=\"text-align:right;\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"24%\" style=\"text-align:right;\" id=\"field4."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField4
													+ "'/>";
											row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"24%\" style=\"text-align:right;\" id=\"field5."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField5
													+ "'/>";
											row.insertCell(5).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"24%\" style=\"text-align:right;\" id=\"field6."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField6
													+ "'/>";
											row.insertCell(6).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"24%\" style=\"text-align:right;\" id=\"field7."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField7
													+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"37%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalDiscAmt
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"37%\" style=\"text-align:right;\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
								...
								.each(
										...
										function(i, item) {
											...
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field2."
													...
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"60%\" style=\"text-align:right;\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
								...
								.each(
										...
										function(i, item) {
											...
											row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field1."
													...
													+ response[i].strField1
													+ "'/>";
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"48%\" style=\"text-align:right;\" id=\"field2."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"48%\" style=\"text-align:right;\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"31%\" style=\"text-align:right;\" id=\"field4."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField4
													+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"54%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalAmount
														+ "'/>";
											...
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field2."
													...
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"59%\" style=\"text-align:right;\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
								...
								.each(
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												var row = table
														.insertRow(rowCount);
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"25%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														...
														+ response[i].totalQuantity
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
												row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"Totfield4."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalDiscAmt
														+ "'/>";
												row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"30%\" style=\"text-align:right;\" id=\"Totfield5."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalTaxAmt
														+ "'/>";
												row.insertCell(5).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"Totfield6."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalAmount
														+ "'/>";
											...
											var row = table.insertRow(rowCount);
											i = i + 1;
											row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:center;\" id=\"field1."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField1
													+ "'/>";
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"field2."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"field3."
													...
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"field4."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField4
													+ "'/>";
											row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"field5."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField5
													+ "'/>";
											row.insertCell(5).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"28%\" style=\"text-align:right;\" id=\"field6."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField6
													+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"26%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalTaxAmt
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"26%\" style=\"text-align:right;\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
											...
											row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"17%\" id=\"field1."
													...
													+ response[i].strField1
													+ "'/>";
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"26%\" style=\"text-align:center;\" id=\"field2."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"17%\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"41%\" id=\"field4."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField4
													+ "'/>";
											row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"16%\" style=\"text-align:right;\" id=\"field5."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField5
													+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"18%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalDiscAmt
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"18%\" style=\"text-align:right;\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalSubTotal
														+ "'/>";
												row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"18%\" style=\"text-align:right;\" id=\"Totfield4."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalTaxAmt
														+ "'/>";
												row.insertCell(4).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"18%\" style=\"text-align:right;\" id=\"Totfield5."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalTipAmt
														+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"44%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalQuantity
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"43%\" style=\"text-align:right;\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalAmount
														+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" style=\"text-align:right;\" id=\"Totfield2."
														...
														+ response[i].totalQuantity
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" style=\"text-align:right;\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalAmount
														+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"35%\" style=\"text-align:right;\" id=\"Totfield2."
														...
														+ response[i].totalAmount
														+ "'/>";
												row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"35%\" style=\"text-align:right;\" id=\"Totfield3."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalDiscAmt
														+ "'/>";
											...
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field2."
													...
													+ response[i].strField2
													+ "'/>";
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"35%\" style=\"text-align:right;\" id=\"field3."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField3
													+ "'/>";
										...
										function(i, item) {
											...
											if (i == 0) {
												...
												row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"Totfield1."
														+ (rowCount)
														+ "\" value=\"Total\" />";
												row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"29%\" style=\"text-align:right;\" id=\"Totfield2."
														+ (rowCount)
														+ "\" value='"
														+ response[i].totalDiscAmt
														+ "'/>";
											...
											row.insertCell(2).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field3."
													...
													+ response[i].strField3
													+ "'/>";
											row.insertCell(3).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"45%\" id=\"field4."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField4
													+ "'/>";
						...
						$
								.each(
										...
										function(i, item) {
											...
											var row = table.insertRow(rowCount);
											i = i + 1;
											row.insertCell(0).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"60%\" style=\"text-align:center;\" id=\"field1."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField1
													+ "'/>";
											row.insertCell(1).innerHTML = "<input readonly=\"readonly\" class=\"Box\" size=\"60%\" style=\"text-align:center;\" id=\"field2."
													+ (rowCount)
													+ "\" value='"
													+ response[i].strField2
													+ "'/>";
...
<body>
	...
	<s:form name="POSSalesReportForm" method="POST"
		action="rptPOSSalesReport.html">
		<br />
		<br />
		<div id="tab_container" style="height: 40%">
			<ul class="tabs">
				<li data-state="tab1"
					style="width: 10%; height: 10%;  padding-left: 2%; margin-left: 10%;"
			...
			<div id="tab1" class="tab_content" style="height: 40%">
				...
				<div style="width: 70%; margin-left: 3%;">
					<table class="masterTable">
						...
						<!-- &emsp;&ensp;&emsp;&ensp; -->
						<tr>
							<td width="30%"><label>POS Name </label>&emsp;&ensp; <s:select
									id="cmbPOSName" name="cmbPOSName" path="strPOSName"
									cssClass="BoxW124px" items="${posList}">
								</s:select></td>
							<td><label>From Date </label>&emsp;&ensp; <s:input
									id="txtFromDate" required="required" path="fromDate"
									pattern="\d{1,2}-\d{1,2}-\d{4}" cssClass="calenderTextBox" /></td>
							<td><label>To Date</label>&emsp;&ensp; <s:input
									id="txtToDate" required="required" path="toDate"
									pattern="\d{1,2}-\d{1,2}-\d{4}" cssClass="calenderTextBox" /></td>
							<td><input id="btnExport" type="submit" value="EXPORT"
								class="form_button1" onclick="funExportReport()" /></td>

						</tr>
						<tr>
							<td><s:input type="hidden" id="hidReportName"
									path="strReportName"></s:input></td>
							<td colspan="4"></td>
						</tr>
						<!-- <tr>
				<td colspan="4">
					...
					<table class="transTablex">
						...
						<tr>
							...
							<td colspan="4">
								...
								<div id="divSettlementWise" class=""
									style="width: 57%; height: 400px; overflow-y: scroll; overflow-x: scroll;">
									<table
										style="height: 20px; border: #0F0; width: 99%; font-size: 11px; font-weight: bold; table-layout: fixed; overflow: scroll"
										class=" transTablex">
										<tr bgcolor="#72BEFC">
											<td width="25%">POS</td>
									...
									<div
										style="background-color: #C0E2FE; border: 1px solid #ccc; display: block; height: 80%; margin: auto; overflow-x: scroll; overflow-y: scroll; width: 99.80%;">
										<table id="tblSettlementWise"
								...
								<div id="divItemWise" class=""
									...
									<div
										style="background-color: #C0E2FE; border: 1px solid #ccc; display: block; height: 80%; margin: auto; overflow-y: scroll; overflow-x: scroll; width: 99.80%;">
								...
								<div id="divDeliveryBoyWise" class=""
									style="width: 57%; height: 400px; overflow-y: scroll; overflow-x: scroll;">
									<table
										style="height: 20px; border: #0F0; width: 99%; font-size: 11px; font-weight: bold;">
										<tr bgcolor="#72BEFC">
								...
								<div id="divCostCenterWise" class=""
									style="width: 57%; height: 400px; overflow-y: scroll; overflow-x: scroll;">
									<table
										style="height: 20px; border: #0F0; width: 99%; font-size: 11px; font-weight: bold;">
										<tr bgcolor="#72BEFC">
								...
								<div id="divHomeDeliveryWise" class=""
									style="width: 57%; height: 400px; overflow-y: scroll; overflow-x: scroll;">
									<table
										style="height: 20px; border: #0F0; width: 99%; font-size: 11px; font-weight: bold;">
										<tr bgcolor="#72BEFC">
								...
								<div id="divItemModifierWise" class=""
									style="width: 57%; height: 400px; overflow-y: scroll; overflow-x: scroll;">
									<table
										style="height: 20px; border: #0F0; width: 99%; font-size: 11px; font-weight: bold;">
										<tr bgcolor="#72BEFC">
								...
								<div id="divMenuHeadWiseWithModifier" class=""
									style="width: 57%; height: 400px; overflow-y: scroll; overflow-x: scroll;">
									<table
										style="height: 20px; border: #0F0; width: 99%; font-size: 11px; font-weight: bold;">
										<tr bgcolor="#72BEFC">
								...
								<div id="divItemHourlyWise" class=""
									style="width: 57%; height: 400px; overflow-y: scroll; overflow-x: scroll;">
									<table
										style="height: 20px; border: #0F0; width: 99%; font-size: 11px; font-weight: bold;">
										<tr bgcolor="#72BEFC">
									...
									<div class=""
										...
										<table
											...
											<tr bgcolor="#72BEFC">
												<td width="30%"></td>
												<td align="right" width="10%">Total Quantity</td>
								...
								<div id="divMonthlySalesFlash" class=""
									style="width: 57%; height: 400px; overflow-y: scroll; overflow-x: scroll;">
									<table
										style="height: 20px; border: #0F0; width: 99%; font-size: 11px; font-weight: bold;">
										<tr bgcolor="#72BEFC">
								...
								<div id="tableImg"
									...
									<table class="transTablex">
										...
										<tr bgcolor="#72BEFC">
											...
											<td style="margin-left: 10px; margin-right: 10px;"><img
			...
			<div id="tab2" class="tab_content" style="height: 400px">
				...
				<table class="masterTable">
					<tr>
						<td><label style="display: inline-block; width: 100px">Operator
						</label> <s:select colspan="3" type="text" items="${Operator}"
								id="txtOperator" path="strOperator" cssClass="BoxW124px" /></td>
						<td><label style="display: inline-block; width: 100px">Pay
								Mode </label> <s:select colspan="3" type="text" items="${PayMode}"
								id="txtPayMode" path="strPayMode" cssClass="BoxW124px" /></td>

					</tr>

					<tr>
						<td><label style="display: inline-block; width: 100px">Time
								From </label> <s:select colspan="3" type="text" items="${HH}"
								id="txtHHFrom" path="strHHFrom" cssClass="BoxW124px">
								<option selected="selected" value="">HH</option>
							</s:select> <s:select colspan="3" type="text" items="${MM}" id="txtMMFrom"
								path="strMMFrom" cssClass="BoxW124px">
								<option selected="selected" value="">MM</option>
							</s:select> <s:select id="txtAMPMFrom" path="strAMPMFrom"
								cssClass="BoxW124px">
								<option selected="selected" value="AM">AM</option>
								<option value="PM">PM</option>
							</s:select></td>
						<td><label style="display: inline-block; width: 100px">To
								Time </label> <s:select colspan="3" type="text" items="${HH}"
								id="txtHHTo" path="strHHTo" cssClass="BoxW124px">
								<option selected="selected" value="">HH</option>
							</s:select> <s:select colspan="3" type="text" items="${MM}" id="txtMMTo"
								path="strMMTo" cssClass="BoxW124px">
								<option selected="selected" value="">MM</option>
							</s:select> <s:select id="txtAMPMTo" path="strAMPMTo" cssClass="BoxW124px">
								<option selected="selected" value="AM">AM</option>
								<option value="PM">PM</option>
							</s:select></td>
					</tr>
					...
					<tr>
						<td><label style="display: inline-block; width: 100px">From
								Bill No</label> <s:input type="text" id="txtFromBillNo"
								path="strFromBillNo" cssClass="longTextBox" /></td>
						<td><label style="display: inline-block; width: 100px">To
								Bill No</label> <s:input type="text" id="txtToBillNo" path="strToBillNo"
								cssClass="longTextBox" /></td>
					</tr>
					<tr>
						<td><label style="display: inline-block; width: 100px">Report
								Type</label> <s:select id="txtReportType" path="strReportType"
								cssClass="BoxW124px">
						...
						<td><label style="display: inline-block; width: 100px">Type</label>
					...
					<tr>
						<td><label style="display: inline-block; width: 100px">Customer</label>
							<s:input type="text" id="txtCustomer" path="strCustomer"
								cssClass="searchTextBox"
								ondblclick="funHelp('POSCustomerMaster')" /></td>
						<td><label style="display: inline-block; width: 100px">Consolidate
								POS</label> <s:input type="checkbox" id="chkConsolidatePOS"
								path="strConsolidatePOS" style="width: 8%"></s:input></td>
					</tr>
