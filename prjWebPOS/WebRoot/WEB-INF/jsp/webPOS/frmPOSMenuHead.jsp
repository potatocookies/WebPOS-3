			...
			<div class="title">
				...
				<div class="row" style="background-color: #fff;">
    				...
    				<div class="element-input col-lg-6" style="margin-bottom: 10px;"> 
						<s:input class="large" colspan="3" type="text" id="txtMenuHeadCode" path="strMenuHeadCode"  ondblclick="funHelp('POSMenuHeadMaster')"/>
					</div>
			 	</div>
...
<br><br>
			<div class="title">
				...
				<div class="row" style="background-color: #fff;">
    				...
    				<div class="element-input col-lg-6" style="margin-bottom: 10px;"> 
						<s:input class="large" colspan="3" type="text" id="txtSubMenuHeadCode" path="strSubMenuHeadCode"  ondblclick="funHelp('POSSubMenuHeadMaster')"/>
					</div>
			 	</div>
			 	<div class="row" style="background-color: #fff;">
					<div class="element-input col-lg-6" > 
			 	...
			 	<div class="row" style="background-color: #fff;">
    				...
    				<div class="element-input col-lg-6" style="margin-bottom: 10px;"> 
						<s:input class="large" colspan="3" type="text" id="txtMenuHeadCodeInSub" path="strMenuHeadCodeInSub"  ondblclick="funHelp('POSMenuHeadMaster')"/>
					</div>
			 	</div>
			 	<div class="row" style="background-color: #fff;">
					<div class="element-input col-lg-6" > 
